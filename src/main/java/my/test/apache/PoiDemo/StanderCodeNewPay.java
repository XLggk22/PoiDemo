 ...
 *
 */
public class StanderCodeNewPay {
	
	public static void main(String[] args) {
		StanderCodeNewPay standerCode = new StanderCodeNewPay();
		String excelPath = "E:/工作文档/破冰项目文件/pcs/接口文档/配置/标准返回码支付V3.0.xlsx";
		String exportPath = "E:/工作文档/破冰项目文件/pcs/接口文档/配置/标准返回码-支付/";
		String channelCode = "JINQIAO";
		String channelName = "金桥服务";
		standerCode.dealExcel(0, 5, excelPath, exportPath,channelCode,channelName);
	}
...
//			exportFile.createNewFile();
			...
			while(iterator.hasNext()){
				...
				if(row.getRowNum()>=1){
					...
					if(null == ChannelReturnList || ChannelReturnList.size() == 0) continue;
...
//						String sqlValue = "null, '"+standardCode+"', '"+standardName+"', '"+"2', '"+channelCode+"', '"+channelName+"', '"+returnCode+"', '"+returnName+"', '"+dateStr+"', '"+dateStr+"'";
						String sqlValue = "null, '"+standardCode+"', '"+standardName+"', '"+"1', '"+channelCode+"', '"+channelName+"', '"+returnCode+"', '"+returnName+"', now(),now()";
						String sql = "INSERT INTO `pcs`.`t_channel_standard_code` (`id`, `standard_code`, `standard_msg`, `standard_type`, `channel_id`, `channel_name`, `return_code`, `return_msg`, `create_datetime`, `update_datetime`) VALUES ("+sqlValue+");";
