 ...
 *
 */
public class StanderCodeNew {
	
	public static void main(String[] args) {
		StanderCodeNew standerCode = new StanderCodeNew();
		String excelPath = "E:/工作文档/破冰项目文件/pcs/接口文档/配置/标准返回码模板新表.xlsx";
		String exportPath = "E:/工作文档/破冰项目文件/pcs/接口文档/配置/标准返回码/";
		String channelCode = "JINQIAO";
		String channelName = "金桥服务";
		standerCode.dealExcel(0, 11, excelPath, exportPath,channelCode,channelName);
	}
...
//						String sqlValue = "null, '"+standardCode+"', '"+standardName+"', '"+"2', '"+channelCode+"', '"+channelName+"', '"+returnCode+"', '"+returnName+"', '"+dateStr+"', '"+dateStr+"'";
						String sqlValue = "null, '"+standardCode+"', '"+standardName+"', '"+"2', '"+channelCode+"', '"+channelName+"', '"+returnCode+"', '"+returnName+"', now(),now()";
